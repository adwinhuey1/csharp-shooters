...
namespace ValkyrieIMS.Controllers
{
    ...
    public class InvoiceController : Controller
    {
        ...
        public InvoiceController(ValkyrieIMSContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,VendorName,Quantity,PurchasePrice,InvoiceDate")] Invoice invoice)
        {

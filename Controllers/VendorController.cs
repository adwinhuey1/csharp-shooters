...
namespace ValkyrieIMS.Controllers
{
    ...
    public class VendorController : Controller
    {
        ...
        public VendorController(ValkyrieIMSContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendorId,VendorName,VendorAddress,VendorEmail,VendorPhone")] Vendor vendor)
        {
